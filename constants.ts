...
export let USERS: User[] = [
  { id: 1, name: 'Ana Silva', role: UserRole.REQUESTER, sector: 'Produção', password: 'senha123' },
...
export const EQUIPMENT_STATUS_COLORS: Record<EquipmentStatus, string> = {
  [EquipmentStatus.OPERATIONAL]: 'bg-green-500 text-white',
  [EquipmentStatus.PARTIAL]: 'bg-yellow-500 text-white',
  [EquipmentStatus.INOPERATIVE]: 'bg-red-600 text-white'
};
