...
export let MOCK_REQUESTS: MaintenanceRequest[] = [
    {
      ...
      maintenanceType: [MaintenanceType.MECHANICAL, MaintenanceType.LUBRICATION],
    ...
    // PREVENTIVAS DE EXEMPLO PARA CADA TIPO
    {
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.ELECTRICAL, items: PREVENTIVE_CHECKLISTS[MaintenanceType.ELECTRICAL].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-007',
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.MECHANICAL, items: PREVENTIVE_CHECKLISTS[MaintenanceType.MECHANICAL].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-008',
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.PNEUMATIC, items: PREVENTIVE_CHECKLISTS[MaintenanceType.PNEUMATIC].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-009',
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.LUBRICATION, items: PREVENTIVE_CHECKLISTS[MaintenanceType.LUBRICATION].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-010',
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.BELT, items: PREVENTIVE_CHECKLISTS[MaintenanceType.BELT].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-011',
      ...
      updatedAt: new Date(),
      attachments: [],
      checklists: [{ type: MaintenanceType.GUARDS_AND_PROTECTIONS, items: PREVENTIVE_CHECKLISTS[MaintenanceType.GUARDS_AND_PROTECTIONS].map(item => ({ item, checked: false }))}],
    },
    {
      id: 'OS-012',
      description: 'Manutenção Preventiva Mista (Elétrica e Mecânica) para a Máquina XPTO.',
      status: RequestStatus.PENDING_APPROVAL,
      isPreventive: true,
      equipmentStatus: EquipmentStatus.OPERATIONAL,
      requester: SYSTEM_USER,
      requesterSector: 'Prensa',
      equipment: ['Prensa PH-08'],
      maintenanceType: [MaintenanceType.ELECTRICAL, MaintenanceType.MECHANICAL],
      failureTime: new Date(),
      createdAt: new Date(),
      updatedAt: new Date(),
      attachments: [],
      checklists: [
        {
            ...
            items: PREVENTIVE_CHECKLISTS[MaintenanceType.ELECTRICAL].map(item => ({ item, checked: false }))
        },
        {
            type: MaintenanceType.MECHANICAL,
            items: PREVENTIVE_CHECKLISTS[MaintenanceType.MECHANICAL].map(item => ({ item, checked: false }))
        }
      ],
    },
    {
      id: 'OS-013',
      description: 'Manutenção Preventiva Completa (Mecânica e Pneumática) para Forno F-05.',
      status: RequestStatus.PENDING_APPROVAL,
      isPreventive: true,
      equipmentStatus: EquipmentStatus.OPERATIONAL,
      requester: SYSTEM_USER,
      requesterSector: 'Forno',
      equipment: ['Forno F-05'],
      maintenanceType: [MaintenanceType.MECHANICAL, MaintenanceType.PNEUMATIC],
      failureTime: new Date(),
      createdAt: new Date(),
      updatedAt: new Date(),
      attachments: [],
      checklists: [
        ...
        {
            type: MaintenanceType.PNEUMATIC,
            items: PREVENTIVE_CHECKLISTS[MaintenanceType.PNEUMATIC].map(item => ({ item, checked: false }))
        }
      ],
    }
];